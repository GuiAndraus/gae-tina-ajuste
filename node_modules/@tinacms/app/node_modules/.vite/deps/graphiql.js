...
function se4({
  ...
  (0, import_react93.useEffect)(() => {
    ...
    return Se5([
      ...
      import("./hint.es-36O6OW6O.js"),
      import("./lint.es2-CF5U2NXE.js"),
      import("./info.es-UZNTDYRV.js"),
      import("./jump.es-YXD3DYEL.js"),
      import("./mode.es-TXDDNPNH.js")
    ]).then((k3) => {
      if (!A3)
        return;
      D7.current = k3;
